...
class Optimization() :
    ...
    def run(self, dataFolder = 'Assets/data', otooleConfig = 'Assets/otooleConfig.yaml', combedData = 'Assets/data.txt', processedData = 'Assets/processedData.txt', script = 'Assets/preprocess.py', model='Assets/model.txt', processedModel='Assets/processedModel.txt', lpFile = 'Assets/result.lp', solFile = 'Assets/solution.sol', resultFile = 'Assets/results.csv', ClewsyModel = 'Scripts/GabrielModel.yaml'):
        ...
        os.system("cbc Assets/result.lp solve -solu Assets/solution.sol")

        # Step five - convert the sol file to a csv file
        #os.system("otoole results cbc csv " + solFile + " " + "Assets" + "csv " + "Final" + otooleConfig)
